@echo off
cd %cd%\adb
adb shell pm disable-user --user 0 android.romstats
...
adb shell pm disable-user --user 0 com.cherish.updater
adb shell pm disable-user --user 0 com.duckduckgo.mobile.android
adb shell pm disable-user --user 0 com.google.android.accessibility.soundamplifier
adb shell pm disable-user --user 0 com.google.android.apps.docs
adb shell pm disable-user --user 0 com.google.android.apps.helprtc
adb shell pm disable-user --user 0 com.google.android.apps.nbu.files
adb shell pm disable-user --user 0 com.google.android.apps.pixelmigrate
...
adb shell pm disable-user --user 0 com.google.android.apps.wearables.maestro.companion
...
adb shell pm disable-user --user 0 com.google.android.pixel.setupwizard
...
adb shell pm disable-user --user 0 io.chaldeaprjkt.gamespace
...
adb shell pm disable-user --user 0 org.lineageos.updater
adb shell pm disable-user --user 0 org.omnirom.logcat
adb shell pm disable-user --user 0 org.omnirom.omnijaws
